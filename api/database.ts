...
export const Database = {
  ...
  sortData(data: any[], sortField: string, sortOrder: SortOrder) {
    ...
    function getProperty(obj: any, property: string): any {
      const properties = property.split(".") || [sortField];
    ...
    return data.sort((a, b) => {
      const aValue = getProperty(a, sortField);
      const bValue = getProperty(b, sortField);
